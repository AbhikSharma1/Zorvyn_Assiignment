...
export default function BalanceTrendChart() {
  ...
  return (
    <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-4 md:p-5 shadow-sm">
      <p className="text-sm font-semibold mb-4 text-slate-800 dark:text-white">Income vs Expenses — 2025</p>
      <ResponsiveContainer width="100%" height={isMobile ? 200 : 260}>
        ...
        >
          ...
          <Area type="monotone" dataKey="income"   name="Income"   stroke="#22c55e" strokeWidth={2} fill="url(#incomeGrad)"  dot={{ r: isMobile ? 2 : 4, fill: "#22c55e" }} activeDot={{ r: 5 }} />
          <Area type="monotone" dataKey="expenses" name="Expenses" stroke="#ef4444" strokeWidth={2} fill="url(#expenseGrad)" dot={{ r: isMobile ? 2 : 4, fill: "#ef4444" }} activeDot={{ r: 5 }} />
        </AreaChart>
      </ResponsiveContainer>
    </div>
  );
